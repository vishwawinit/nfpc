...
interface UserWiseJourneyAttendanceProps {
  loginUserCode?: string
}

export const UserWiseJourneyAttendance: React.FC<UserWiseJourneyAttendanceProps> = ({ loginUserCode = 'admin' }) => {
  ...
  }, [queryParams, filters.startDate, filters.endDate, loginUserCode])
